...
| **目標 Minecraft 版本** | `26.1.2 (Modern Standard)` |
| **Java 實作** | [`MultiNoiseBiomeSourceMixin.java`](file:///Biome%20Scale%2026.1/src/main/java/net/vanillaoutsider/biomescale/mixin/MultiNoiseBiomeSourceMixin.java) |
...
*(在當前 MC 26.1 的實作中，$S_h = S_{\text{eff}}$ 且 $S_v = 1.0$，從而在水平擴大生態域的同時，完整保留垂直三維洞穴與山脈的氣候帶分層)。*
...
* [[26.1 Architecture & Mixins|zh_tw-26.1-Architecture-and-Mixins]]
