...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| **Minecraft 26.1** | 现代主流标准 | 🟢 长期支持 | `>=0.19.1` | `0.145.4+26.1.2` | Java 25 | [[👉 进入 MC 26.1 文档|26.1-Home]] |
| **Minecraft 26.3** | 现代先锋快照 | 🟡 对齐归档 | `>=0.19.3` | `0.156.1+26.3` | Java 25 | [[👉 进入 MC 26.3 文档|26.3-Home]] |
...
* [[版本兼容性矩阵|Version-Compatibility]] — 支持生命周期、工具链映射与 Java 环境要求。
* [[开发环境搭建与构建|Developer-Setup-and-Building]] — 环境配置、Loom Gradle 构建步骤与测试验证。
