...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| **Minecraft 26.1** | 現代主流標準 | 🟢 長期支援 | `>=0.19.1` | `0.145.4+26.1.2` | Java 25 | [[👉 進入 MC 26.1 文件|zh_tw-26.1-Home]] |
| **Minecraft 26.3** | 現代先鋒快照 | 🟡 對齊歸檔 | `>=0.19.3` | `0.156.1+26.3` | Java 25 | [[👉 進入 MC 26.3 文件|zh_tw-26.3-Home]] |
...
* [[版本相容性矩陣|zh_tw-Version-Compatibility]] — 支援生命週期、工具鏈映射與 Java 環境要求。
* [[開發環境建置與編譯|zh_tw-Developer-Setup-and-Building]] — 環境配置、Loom Gradle 編譯步驟與測試驗證。
