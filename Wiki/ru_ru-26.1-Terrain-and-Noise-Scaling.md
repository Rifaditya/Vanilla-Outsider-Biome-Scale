# MC 26.1: Механика масштабирования рельефа и шума
...
| **Целевая версия Minecraft** | `26.1.2 (Modern Standard)` |
| **Реализация Java** | [`MultiNoiseBiomeSourceMixin.java`](file:///Biome%20Scale%2026.1/src/main/java/net/vanillaoutsider/biomescale/mixin/MultiNoiseBiomeSourceMixin.java) |
...
```
[ Запуск генерации чанка (MC 26.1) ]
               │
               ▼
...
## 🧭 Version Navigation
* [[Back to MC 26.1 Portal|ru_ru-26.1-Home]]
* [[26.1 Configuration & GameRules|ru_ru-26.1-Configuration-and-GameRules]]
* [[26.1 Architecture & Mixins|ru_ru-26.1-Architecture-and-Mixins]]
